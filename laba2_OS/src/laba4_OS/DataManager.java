...
public class DataManager extends JPanel{
	...
	public void CreateFile(int size) {
		if (size > freememory) {
			Main.textAreaWindow.append("Íåâîçìîæíî äîáàâèòü ôàéë, íå õâàòàåò ïàìÿòè");
			return;
		}
		...
		Main.textAreaWindow.append("Äîáàâëåí ôàéë ¹" + fileId + "\n");
	...
	public void DeleteFile(int id) {
		if (files.get(id) == null) {
			...
			files.remove(id);			
			Main.textAreaWindow.append("Óäàë¸í ôàéë" + Main.textFieldId.getText() + "\n");
		}
		Main.textAreaWindow.append("Ñâîáîäíî ïàìÿòè:" + freememory + "\n");
